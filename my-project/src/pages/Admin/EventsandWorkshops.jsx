...
export default function EventsComponent() {
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const response = await fetch('https://gbv-plp-hacks.onrender.com/api/events/', {
  ...
  const executeDelete = async () => {
    ...
    try {
      ...
      const endpoint = `https://gbv-plp-hacks.onrender.com/api/events/${itemToDelete.id}/`;
  ...
  const handleSaveEvent = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://gbv-plp-hacks.onrender.com/api/events/${editingEventId}/`, {
        method: 'PUT',
        headers: { 
          'Content-Type': 'application/json',
          'Authorization': `Token ${token}`
