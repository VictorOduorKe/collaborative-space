...
ALLOWED_HOSTS = [
    ...
    'www.safespacekenya.co.ke', 
    '127.0.0.1',
    'gbv-plp-hacks.onrender.com',  # Add this
]
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:3000",
    'https://collaborative-space.onrender.com',
    'https://gbv-plp-hacks.onrender.com',  # Add your actual backend domain
]

# Alternative: For development, you can allow all origins (be careful in production)
